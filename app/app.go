...
import (
	...
	incentivemodule "hhand/x/incentive"
	incentivemodulekeeper "hhand/x/incentive/keeper"
	incentivemoduletypes "hhand/x/incentive/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "hhand/app/params"
	"hhand/docs"
)
...
var (
	...
	maccPerms = map[string][]string{
		...
		incentivemoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
type App struct {
	*baseapp.BaseApp
	...
	ScopedIncentiveKeeper capabilitykeeper.ScopedKeeper
...
func New(
	...
	*/
	...
	scopedIncentiveKeeper := app.CapabilityKeeper.ScopeToModule(incentivemoduletypes.ModuleName)
	app.ScopedIncentiveKeeper = scopedIncentiveKeeper
	...
	ibcRouter.AddRoute(incentivemoduletypes.ModuleName, incentiveIBCModule)
